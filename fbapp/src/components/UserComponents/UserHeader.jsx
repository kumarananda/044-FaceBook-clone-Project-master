...
import UserLogOut from "../UtilityComponents/UserLogOut";
...
const UserHeader = () => {
  ...
  const [actMenu, actActMenu] = useState(false);
  ...
  const [droupdown, setDroupdown] = useState(false);
      ...
      <div className="fb-home-header">
        ...
        <div className="fb-home-menu">
          <ul>
            <li className="active">
              <Link to="/">
                <svg viewBox="0 0 28 28" className="x1lliihq x1k90msu x2h7rmj x1qfuztq x5e5rjt" fill="currentColor" height="28" width="28">
            ...
            <li>
              <Link to="/">
                <svg viewBox="0 0 28 28" className="x1lliihq x1k90msu x2h7rmj x1qfuztq xcza8v6" fill="currentColor" height="28" width="28">
        ...
        <div className="fb-home-user">
          ...
          <div ref={menuRef} className="fb-user-item">
            <button className="nutural-circle-btn" onClick={() => setDroupdown(!droupdown)}>
              <UserAvater />
            </button>
            {droupdown && (
