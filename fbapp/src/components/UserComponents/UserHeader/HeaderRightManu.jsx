...
const HeaderRightManu = () => {
  const dropManuRef = useRef(null);
  // use coustom hooks
  const [dropManu, setDropManu] = useState(false);

  useMouseDown(dropManuRef, dropManu, setDropManu);
          ...
          {dropManu && (
            <>
              <div className={`user-menu-dropdown`}>
                {/* <div ref={dropManuRef} className={`user-menu-dropdown`}> */}
                <div className="user-menu-box">
                  <div className="user-data-box">
                    <div className="user-data-box-item">
                      <UserAvater />
                      <UserName font_Size={20} />
                    </div>
...
export default HeaderRightManu;
